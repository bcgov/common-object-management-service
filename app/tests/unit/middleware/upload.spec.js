...
describe('currentUpload', () => {
  ...
  it.each([
    ...
    [1, {
      contentLength: 539, filename: undefined, mimeType: 'application/octet-stream'
    }, false, 539, undefined, undefined],
    [1, {
      contentLength: 539, filename: undefined, mimeType: 'application/octet-stream'
    }, false, 539, 'inline', undefined],
    [1, {
      contentLength: 539, filename: undefined, mimeType: 'application/octet-stream'
    }, false, 539, 'xattachment', undefined],
    [1, {
      contentLength: 539, filename: undefined, mimeType: 'application/octet-stream'
    }, false, 539, 'attachment; xfilename="foo.txt"', undefined],
    [1, {
    ...
    }, false, 539, 'attachment; filename=foo.txt; filename*=UTF-8\'\'f%C3%B6o.txt', 'text/plain'],
    [1, {
      contentLength: 539, filename: 'föo.txt', mimeType: 'text/plain'
    }, false, 539, 'attachment; filename*=UTF-8\'\'f%C3%B6o.txt; filename=foo.txt', 'text/plain'],
    ...
    [1, {
      contentLength: 539, filename: 'foo.txt', mimeType: 'application/octet-stream'
    }, true, 539, 'attachment; filename="foo.txt"', undefined],
    [1, {
      contentLength: 539, filename: 'foo.txt', mimeType: 'text/plain'
    ...
    [1, {
      contentLength: 539, filename: 'föo.txt', mimeType: 'text/plain'
    }, true, 539, 'attachment; filename*=UTF-8\'\'f%C3%B6o.txt; filename=foo.txt', 'text/plain']
