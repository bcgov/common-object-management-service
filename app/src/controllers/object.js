  ...
  async createObject(req, res, next) {
    try {
      ...
      try {
        ...
        // TODO: add coms-id to error message if exists
        if (err.$response?.headers['x-amz-delete-marker']) {
          ...
          throw new Problem(409, 'Bucket already contains a soft-deleted version of this object', req.originalUrl, {
            detail: 'Bucket already contains a soft-deleted version of this object',
            existingObjectId: objectId,
          });
